...
class PrductSubCategory(models.Model):
    main_category    = models.ForeignKey(ProductMainCategory, on_delete=models.CASCADE, related_name='sub_category')
...
#     updated_by    = models.ForeignKey(User, on_delete=models.CASCADE, related_name="group_permission_updated_by_user", null=True)
#     deleted_by    = models.ForeignKey(User, on_delete=models.CASCADE, related_name="group_permission_deleted_by_user", null=True)
#     is_active     = models.BooleanField(default=True)
#     deleted       = models.BooleanField(default=False)
